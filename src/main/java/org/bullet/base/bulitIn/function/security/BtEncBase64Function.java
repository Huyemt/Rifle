...
public class BtEncBase64Function extends BtFunction {
    ...
    public Object invokeFV(Object... args) throws BulletException {
        ...
        if (args.length == 1) {
            ...
            return Crypto4J.Base64.encrypt(args[0].toString());
        }
        ...
        for (Object obj : args) {
            ...
            array.vector.add(Crypto4J.Base64.encrypt(obj.toString()));
        }
