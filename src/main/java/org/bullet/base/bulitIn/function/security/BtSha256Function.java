...
public class BtSha256Function extends BtFunction {
    public BtSha256Function(BulletRuntime runtime) {
        super("sha256", runtime);
    }
    ...
    public Object invokeFV(Object... args) throws BulletException {
        ...
        if (args.length == 1) {
            ...
            return Crypto4J.SHA256.encrypt(args[0].toString());
        }
        ...
        for (Object obj : args) {
            ...
            array.vector.add(Crypto4J.SHA256.encrypt(obj.toString()));
        }
    ...
    private BtArray encryptArr(BtArray array) throws BulletException {
        ...
        for (Object v : array.vector) {
            ...
            r.vector.add(Crypto4J.SHA256.encrypt(v.toString()));
        }
